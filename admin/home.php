...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        if(isset($_SESSION['success'])){
          echo "
            <div class='alert alert-success alert-dismissible'>
              <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
              <h4><i class='icon fa fa-check'></i> Амжилттай нэвтэрлээ!</h4>
              ".$_SESSION['success']."
            </div>
          ";
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6" style="width: 260px">
          <!-- small box -->
          <div class="small-box" style="background: coral">
            <div class="inner">
              ...
              <p>Тэтгэвэр, тэтгэмж</p>
            </div>
            <div class="icon">
              <i class="fa fa-tasks"></i>
            </div>
            <a href="olgolt.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6" style="width: 250px">
          <!-- small box -->
          <div class="small-box" style="background: peachpuff">
            <div class="inner">
              <?php
            ...
            <a href="irgen.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6" style="width: 250px">
          <!-- small box -->
          <div class="small-box" style="background: sandybrown">
            <div class="inner">
              <?php
